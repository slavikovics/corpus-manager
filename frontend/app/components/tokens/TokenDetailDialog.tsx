            ...
            <div className="space-y-6 pb-4">
              ...
              <Card className="p-6 ml-2 mr-2 bg-card border-border shadow-sm">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  ...
                  <InfoItem label="NER" value={token.entity_type || "-"} />
                </div>
                  ...
                  <div className="space-y-4">
                    {token.head !== null ? (
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <Badge
                          variant="outline"
                          className="bg-white-500/10 text-white-700 dark:text-white-300 border-white-200 dark:border-white-800"
                        >
                          {token.head}
                        </Badge>
                      </div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Нет информации о главном слове
                      </p>
                    )}
                  </div>
                </Card>
